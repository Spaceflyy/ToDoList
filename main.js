...
const model = () => {
	...
	const getWeekTasks = (allTasks) => {
		...
		allTasks.forEach((task) => {
			if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate), { weekStartsOn: 1 })) {
				weekTasks.push(task);
			}
		});
		return weekTasks;
	...
	const getMonthTasks = (allTasks) => {
		...
		allTasks.forEach((task) => {
			if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate))) {
	...
	const toggleCompleted = (taskId) => {
		...
		pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().publish("tasksUpdated", projectsList[getCurrentProject()].taskList);
	};
	...
	const deleteProject = (id) => {
		...
		if (projectsList[getCurrentProject()] === undefined) {
			pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().publish("tasksUpdated", undefined);
		} else {
			pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().publish("tasksUpdated", projectsList[getCurrentProject()].taskList);
		}
	...
	const updateTasks = (tasks) => {
		...
		if (tasks.length > 0) {
			...
			tasks.forEach((element) => {
				...
				date.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(element.dueDate), "dd/MM/yyyy");
...
const controller = (() => {
	...
	viewable.updateTasks(_model__WEBPACK_IMPORTED_MODULE_3__["default"].projectsList[_model__WEBPACK_IMPORTED_MODULE_3__["default"].getCurrentProject()].taskList);
	viewable.setActiveProject(_model__WEBPACK_IMPORTED_MODULE_3__["default"].getClickedProject(_model__WEBPACK_IMPORTED_MODULE_3__["default"].getCurrentProject()));
	...
	const handleEditTask = (updateTask) => {
		_model__WEBPACK_IMPORTED_MODULE_3__["default"].updateTask(updateTask);
	};
	const handleEditProject = (newTitle) => {
		_model__WEBPACK_IMPORTED_MODULE_3__["default"].updateProject(viewable.getProjToEdit(), newTitle);
	};
	const handleClick = (event) => {
		...
		if (target.classList.contains("project")) {
			...
			viewable.setActiveProject(
				_model__WEBPACK_IMPORTED_MODULE_3__["default"].getClickedProject(target.getAttribute("data-project-id"))
			);
			viewable.updateTasks(_model__WEBPACK_IMPORTED_MODULE_3__["default"].projectsList[_model__WEBPACK_IMPORTED_MODULE_3__["default"].getCurrentProject()].taskList);
		}
		...
		if (target.getAttribute("type") === "checkbox") {
			_model__WEBPACK_IMPORTED_MODULE_3__["default"].toggleCompleted(target.parentElement.getAttribute("data-task-id"));
		}
		if (target.getAttribute("id") === "allBtn") {
			viewable.updateTasks(_model__WEBPACK_IMPORTED_MODULE_3__["default"].getAllProjectTasks());
		}

		if (target.getAttribute("id") === "thisWeekBtn") {
			viewable.updateTasks(_model__WEBPACK_IMPORTED_MODULE_3__["default"].getWeekTasks());
		}

		if (target.getAttribute("id") === "thisMonthBtn") {
			viewable.updateTasks(_model__WEBPACK_IMPORTED_MODULE_3__["default"].getMonthTasks());
		}

		if (target.getAttribute("id") === "projEdt") {
			const clickedProject = target.parentElement.getAttribute("data-project-id");
			viewable.showModal(_model__WEBPACK_IMPORTED_MODULE_3__["default"].projectsList[clickedProject], "projEdit");
		}
