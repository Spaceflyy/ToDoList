...
"use strict";
module.exports = __webpack_require__.p + "imgs/delete.svg";
...
"use strict";
module.exports = __webpack_require__.p + "imgs/edit.svg";
...
const controller = (() => {
	...
	_model__WEBPACK_IMPORTED_MODULE_3__["default"].setPermanentTasks();
	...
	const handleClick = (event) => {
		...
		if (target.getAttribute("type") === "checkbox") {
			_model__WEBPACK_IMPORTED_MODULE_3__["default"].toggleCompleted(
		...
		if (target.getAttribute("id") === "taskDel") {
			_model__WEBPACK_IMPORTED_MODULE_3__["default"].deleteTask(
				target.parentElement.getAttribute("data-proj-id"),
				target.parentElement.getAttribute("data-task-id")
			);
		}
	...
	pubsub_js__WEBPACK_IMPORTED_MODULE_1___default().subscribe("ListUpdated", (msg, data) => {
		...
		viewable.setActiveProject(_model__WEBPACK_IMPORTED_MODULE_3__["default"].getClickedProject(_model__WEBPACK_IMPORTED_MODULE_3__["default"].getCurrentProject()));
		_model__WEBPACK_IMPORTED_MODULE_3__["default"].updateStorage();
	});
